...
// Get personal care products with error handling
try {
    $personalCareProducts = Product::getByCategory('Personal Care', $perPage, $offset, $sortField, $sortOrder);
    $totalProducts = Product::count(['category' => 'Personal Care']);
    $totalPages = ceil($totalProducts / $perPage);
} catch (Exception $e) {
    error_log("Error loading personal care products: " . $e->getMessage());
    $personalCareProducts = [];
    $totalProducts = 0;
    $totalPages = 1;
    echo '<div class="alert alert-danger">Error loading personal care products. Please try again later.</div>';
}
...
<section class="hero-section py-5 bg-gradient-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-3">Personal Care Essentials</h1>
                <p class="lead mb-4">Discover our premium selection of personal care products for your daily routine.</p>
            ...
            <div class="col-lg-6">
                <img src="https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" 
                     alt="Personal Care Products" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold mb-2">Our Personal Care Selection</h2>
                <p class="text-muted">
                    <?= $totalProducts ?> personal care products available
                    <?php if ($totalPages > 1): ?>
        ...
        <?php if (empty($personalCareProducts)): ?>
            <div class="text-center py-5">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    No personal care products available at the moment. Check back soon!
                </div>
        ...
        <?php else: ?>
            ...
            <?php foreach (array_chunk($personalCareProducts, 4) as $productGroup): ?>
...
<section class="newsletter-section bg-primary text-white py-5">
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="fw-bold mb-3">Personal Care Tips & Offers</h2>
                <p class="lead mb-4">Subscribe to get updates on our newest personal care products and wellness tips.</p>
                
                <form class="newsletter-form" id="personalCareNewsletterForm" action="<?= base_url('includes/newsletter-subscribe.php') ?>" method="POST">
                    ...
                    <div class="form-text mt-2 text-white-50">
                        We'll email you about personal care products and tips. Unsubscribe anytime.
                    </div>
                </form>
            </div>
        </div>
...
<script>
// Newsletter Form Handling for personal care page
document.addEventListener('DOMContentLoaded', function() {
    const newsletterForm = document.getElementById('personalCareNewsletterForm');
