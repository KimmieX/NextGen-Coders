...
try {
    $featuredProducts = Product::getFeatured($perPage, $offset, $sortField, $sortOrder);
    $totalProducts = Product::count(['featured' => 1]);
    ...
    $totalProducts = 0;
    $totalPages = 1;
    echo '<div class="alert alert-danger">Error loading featured products. Please try again later.</div>';
}
...
<section class="hero-section py-5 bg-gradient-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-3">Featured Products</h1>
                <p class="lead mb-4">Discover our handpicked selection of premium products.</p>
            ...
            <div class="col-lg-6">
                <img src="https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" 
                     alt="Featured Products" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold mb-2">Our Featured Selection</h2>
                <p class="text-muted">
        ...
        <?php else: ?>
            ...
            <?php foreach (array_chunk($featuredProducts, 4) as $productGroup): ?>
...
<section class="newsletter-section bg-primary text-white py-5">
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="fw-bold mb-3">Want Featured Product Updates?</h2>
                <p class="lead mb-4">Subscribe to get updates on our premium featured products.</p>
                
                <form class="newsletter-form" id="featuredProductsNewsletterForm" action="<?= base_url('includes/newsletter-subscribe.php') ?>" method="POST">
                    ...
                    <div class="form-text mt-2 text-white-50">
                        We'll email you about new featured products. Unsubscribe anytime.
                    </div>
                </form>
            </div>
        </div>
...
<script>
// Newsletter Form Handling for featured products page
document.addEventListener('DOMContentLoaded', function() {
    const newsletterForm = document.getElementById('featuredProductsNewsletterForm');
