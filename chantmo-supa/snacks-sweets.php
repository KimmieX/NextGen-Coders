...
// Get snacks & sweets with error handling
try {
    $snacksSweets = Product::getByCategory('Snacks & Sweets', $perPage, $offset, $sortField, $sortOrder);
    $totalProducts = Product::count(['category' => 'Snacks & Sweets']);
    $totalPages = ceil($totalProducts / $perPage);
} catch (Exception $e) {
    error_log("Error loading snacks & sweets: " . $e->getMessage());
    $snacksSweets = [];
    $totalProducts = 0;
    $totalPages = 1;
    echo '<div class="alert alert-danger">Error loading snacks & sweets. Please try again later.</div>';
}
...
<!-- Hero Section with adjusted image height -->
<section class="hero-section py-5 bg-gradient-light" style="min-height: 400px;">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-3">Delicious Snacks & Sweets</h1>
                <p class="lead mb-4">Satisfy your cravings with our wide selection of tasty treats and indulgences.</p>
            ...
            <div class="col-lg-6">
                <img src="https://images.unsplash.com/photo-1551024506-0bccd828d307?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1557&q=80" 
                     alt="Snacks & Sweets" class="img-fluid rounded shadow-lg" style="max-height: 400px; width: 100%; object-fit: cover;">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold mb-2">Our Snacks & Sweets Selection</h2>
                <p class="text-muted">
        ...
        <?php if (empty($snacksSweets)): ?>
            <div class="text-center py-5">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    No snacks & sweets available at the moment. Check back soon!
                </div>
        ...
        <?php else: ?>
            ...
            <?php foreach (array_chunk($snacksSweets, 4) as $productGroup): ?>
...
<section class="newsletter-section bg-primary text-white py-5">
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="fw-bold mb-3">Want Snacks & Sweets Updates?</h2>
                <p class="lead mb-4">Subscribe to get updates on our newest treats and special offers.</p>
                
                <form class="newsletter-form" id="snacksNewsletterForm" action="<?= base_url('includes/newsletter-subscribe.php') ?>" method="POST">
                    ...
                    <div class="form-text mt-2 text-white-50">
                        We'll email you about new snacks & sweets. Unsubscribe anytime.
                    </div>
                </form>
            </div>
        </div>
...
<script>
// Newsletter Form Handling for snacks page
document.addEventListener('DOMContentLoaded', function() {
    const newsletterForm = document.getElementById('snacksNewsletterForm');
