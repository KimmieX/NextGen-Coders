...
if (!isset($_GET['token'])) {
    $_SESSION['newsletter_error'] = 'Invalid verification token';
...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if ($subscriber) {
            ...
            $body = "Thank you for subscribing to our newsletter! Here's your exclusive 20% discount code: <strong>CHANTMO20</strong><br><br>"
    ...
    $_SESSION['newsletter_error'] = $e->getMessage();
    redirect('/chantmo-supa/index.php');
}