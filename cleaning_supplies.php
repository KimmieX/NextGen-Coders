...
// Get cleaning supplies with error handling
try {
    $cleaningProducts = Product::getByCategory('Cleaning Supplies', $perPage, $offset, $sortField, $sortOrder);
    $totalProducts = Product::count(['category' => 'Cleaning Supplies']);
    $totalPages = ceil($totalProducts / $perPage);
} catch (Exception $e) {
    error_log("Error loading cleaning supplies: " . $e->getMessage());
    $cleaningProducts = [];
    $totalProducts = 0;
    $totalPages = 1;
    echo '<div class="alert alert-danger">Error loading cleaning supplies. Please try again later.</div>';
}
...
<section class="hero-section py-5 bg-gradient-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-4 fw-bold mb-3">Cleaning Supplies</h1>
                <p class="lead mb-4">Keep your home spotless with our premium cleaning products and supplies.</p>
            ...
            <div class="col-lg-6">
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" 
                     alt="Cleaning Supplies" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold mb-2">Our Cleaning Products</h2>
                <p class="text-muted">
                    <?= $totalProducts ?> cleaning products available
                    <?php if ($totalPages > 1): ?>
        ...
        <?php if (empty($cleaningProducts)): ?>
            <div class="text-center py-5">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    No cleaning products available at the moment. Check back soon!
                </div>
        ...
        <?php else: ?>
            ...
            <?php foreach (array_chunk($cleaningProducts, 4) as $productGroup): ?>
...
<section class="newsletter-section bg-primary text-white py-5">
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h2 class="fw-bold mb-3">Want Cleaning Tips & Offers?</h2>
                <p class="lead mb-4">Subscribe to get updates on our newest cleaning products and special offers.</p>
                
                <form class="newsletter-form" id="cleaningNewsletterForm" action="<?= base_url('includes/newsletter-subscribe.php') ?>" method="POST">
                    ...
                    <div class="form-text mt-2 text-white-50">
                        We'll email you cleaning tips and offers. Unsubscribe anytime.
                    </div>
                </form>
            </div>
        </div>
...
<script>
// Newsletter Form Handling for cleaning supplies page
document.addEventListener('DOMContentLoaded', function() {
    const newsletterForm = document.getElementById('cleaningNewsletterForm');
